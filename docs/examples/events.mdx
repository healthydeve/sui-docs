...
A user can use events emitted by a smart contract by calling the query_events api call and
track events emitted by a specific package, module, and function. These are especially helpful in
tracking what goes on in the ecosystem like if we are interested in how many capys got minted we can
...
--data '{
    ...
    "params": {
        "query": {
            "MoveModule":{"package":"0xf5b55a91957b68f23107522abf96634a0d58ccad6ff9ecd6daf3eba8808b3dd9", "module":"mint_app"}
        },
...
See https://docs.sui.io/build/event_api for more details about the API.

The below example is a continuation of the the example smart contract for events, and note that we can build
different kinds of events to be emitted.
